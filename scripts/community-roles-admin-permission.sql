...
-- Run this ENTIRE script in Supabase SQL Editor (fixes FK errors on Access Control save)
...
-- Lets Access Control UI upsert catalog keys before assigning to roles
