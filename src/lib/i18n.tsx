...
const fallback: Record<string, { bn: string; en: string }> = {
  ...
  searchUpazila: { bn: "উপজেলা খুঁজুন…", en: "Search upazila…" },
  gender: { bn: "লিঙ্গ", en: "Gender" },
  male: { bn: "পুরুষ", en: "Male" },
  female: { bn: "নারী", en: "Female" },
  age: { bn: "বয়স", en: "Age" },
  ageOptional: { bn: "বয়স (ঐচ্ছিক)", en: "Age (optional)" },
  completeProfile: { bn: "প্রোফাইল সম্পূর্ণ করুন", en: "Complete your profile" },
  completeProfileHint: {
    bn: "অ্যাপ ব্যবহার করতে রক্তের গ্রুপ, লিঙ্গ ও এলাকা দিন",
    en: "Add blood group, gender and location to continue",
  },
  continue: { bn: "চালিয়ে যান", en: "Continue" },
  requiredField: { bn: "আবশ্যক", en: "Required" },
  ...
  pin: { bn: "৪ সংখ্যার PIN", en: "4-digit PIN" },
  confirmPin: { bn: "PIN নিশ্চিত করুন", en: "Confirm PIN" },
  ...
  canDonate: { bn: "রক্ত দিতে পারি", en: "I can donate" },
  iDonated: { bn: "আমি দিয়েছি", en: "I donated" },
  assignDonor: { bn: "ডোনার assign করুন", en: "Assign a donor" },
  donationProgress: { bn: "রক্তদান অগ্রগতি", en: "Donation progress" },
  helpedBy: { bn: "সহায়তা করেছেন", en: "Helped by" },
  menu: { bn: "মেনু", en: "Menu" },
  savePost: { bn: "সেভ", en: "Save" },
  myPosts: { bn: "আমার পোস্ট", en: "My posts" },
  likedPosts: { bn: "লাইক করা", en: "Liked" },
  commentedPosts: { bn: "কমেন্ট করা", en: "Commented" },
  sharedPosts: { bn: "শেয়ার করা", en: "Shared" },
  savedPosts: { bn: "সেভ করা", en: "Saved" },
  donatedPosts: { bn: "রক্ত দিয়েছি", en: "Donated" },
