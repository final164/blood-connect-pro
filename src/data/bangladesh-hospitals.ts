...
const NAMED: HospitalSeed[] = [
  // Dhaka — government (area-scoped)
  { districtSlug: "dhaka", type: "government", slug: "dmch", name_en: "Dhaka Medical College Hospital", name_bn: "ঢাকা মেডিকেল কলেজ হাসপাতাল", upazila: "Shahbag" },
  { districtSlug: "dhaka", type: "government", slug: "bsmmu", name_en: "Bangabandhu Sheikh Mujib Medical University (BSMMU)", name_bn: "বঙ্গবন্ধু শেখ মুজিব মেডিকেল বিশ্ববিদ্যালয় হাসপাতাল", upazila: "Shahbag" },
  { districtSlug: "dhaka", type: "government", slug: "ssmch", name_en: "Sir Salimullah Medical College Mitford Hospital", name_bn: "স্যার সলিমুল্লাহ মেডিকেল কলেজ মিটফোর্ড হাসপাতাল", upazila: "Lalbagh" },
  { districtSlug: "dhaka", type: "government", slug: "shsmch", name_en: "Shaheed Suhrawardy Medical College Hospital", name_bn: "শহীদ সোহরাওয়ার্দী মেডিকেল কলেজ হাসপাতাল", upazila: "Sher-e-Bangla Nagar" },
  { districtSlug: "dhaka", type: "government", slug: "nicvd", name_en: "National Institute of Cardiovascular Diseases (NICVD)", name_bn: "জাতীয় হৃদরোগ ইনস্টিটিউট", upazila: "Sher-e-Bangla Nagar" },
  { districtSlug: "dhaka", type: "government", slug: "nitor", name_en: "National Institute of Traumatology & Orthopaedic Rehabilitation (NITOR)", name_bn: "জাতীয় অর্থোপেডিক হাসপাতাল (নিটোর)", upazila: "Sher-e-Bangla Nagar" },
  { districtSlug: "dhaka", type: "government", slug: "nicrh", name_en: "National Institute of Cancer Research & Hospital", name_bn: "জাতীয় ক্যানসার গবেষণা ইনস্টিটিউট ও হাসপাতাল", upazila: "Mohakhali" },
  { districtSlug: "dhaka", type: "government", slug: "nimh", name_en: "National Institute of Mental Health", name_bn: "জাতীয় মানসিক স্বাস্থ্য ইনস্টিটিউট", upazila: "Sher-e-Bangla Nagar" },
  { districtSlug: "dhaka", type: "government", slug: "nidch", name_en: "National Institute of Diseases of the Chest & Hospital", name_bn: "জাতীয় বক্ষব্যাধি ইনস্টিটিউট", upazila: "Mohakhali" },
  { districtSlug: "dhaka", type: "government", slug: "nigeb", name_en: "National Institute of Neurosciences & Hospital", name_bn: "জাতীয় নিউরোসায়েন্স ইনস্টিটিউট", upazila: "Agargaon" },
  { districtSlug: "dhaka", type: "government", slug: "dmch-burn", name_en: "Sheikh Hasina National Burn & Plastic Surgery Institute", name_bn: "শেখ হাসিনা জাতীয় বার্ন ও প্লাস্টিক সার্জারি ইনস্টিটিউট", upazila: "Shahbag" },
  { districtSlug: "dhaka", type: "government", slug: "dghs-kurmitola", name_en: "Kurmitola General Hospital", name_bn: "কুর্মিটোলা জেনারেল হাসপাতাল", upazila: "Cantonment" },
  { districtSlug: "dhaka", type: "government", slug: "mugda", name_en: "Mugda Medical College Hospital", name_bn: "মুগদা মেডিকেল কলেজ হাসপাতাল", upazila: "Mugda" },
  { districtSlug: "dhaka", type: "government", slug: "dncc-mohakhali", name_en: "DNCC Dedicated COVID / Mohakhali Hospital", name_bn: "ডিএনসিসি মহাখালী হাসপাতাল", upazila: "Mohakhali" },
  { districtSlug: "dhaka", type: "government", slug: "bangladesh-secretariat-clinic", name_en: "Bangladesh Secretariat Clinic", name_bn: "বাংলাদেশ সচিবালয় ক্লিনিক", upazila: "Paltan" },
  { districtSlug: "dhaka", type: "government", slug: "kuwait-bangladesh-friendship", name_en: "Kuwait Bangladesh Friendship Government Hospital", name_bn: "কুয়েত বাংলাদেশ ফ্রেন্ডশিপ সরকারি হাসপাতাল", upazila: "Uttara" },
  { districtSlug: "dhaka", type: "government", slug: "dhaka-shishu", name_en: "Dhaka Shishu (Children) Hospital", name_bn: "ঢাকা শিশু হাসপাতাল", upazila: "Sher-e-Bangla Nagar" },
  { districtSlug: "dhaka", type: "government", slug: "national-eye-institute", name_en: "National Institute of Ophthalmology", name_bn: "জাতীয় চক্ষু বিজ্ঞান ইনস্টিটিউট", upazila: "Sher-e-Bangla Nagar" },
  // Dhaka — private (area-scoped)
  { districtSlug: "dhaka", type: "private", slug: "square", name_en: "Square Hospital", name_bn: "স্কয়ার হাসপাতাল", upazila: "Panthapath" },
  { districtSlug: "dhaka", type: "private", slug: "united", name_en: "United Hospital", name_bn: "ইউনাইটেড হাসপাতাল", upazila: "Gulshan" },
  { districtSlug: "dhaka", type: "private", slug: "evercare", name_en: "Evercare Hospital Dhaka", name_bn: "এভারকেয়ার হাসপাতাল ঢাকা", upazila: "Bashundhara" },
  { districtSlug: "dhaka", type: "private", slug: "apollo-dhaka", name_en: "Apollo Imperial Hospitals", name_bn: "অ্যাপোলো ইম্পেরিয়াল হাসপাতাল", upazila: "Tejgaon" },
  { districtSlug: "dhaka", type: "private", slug: "labaid", name_en: "Labaid Specialized Hospital", name_bn: "ল্যাবএইড স্পেশালাইজড হাসপাতাল", upazila: "Dhanmondi" },
  { districtSlug: "dhaka", type: "private", slug: "popular", name_en: "Popular Diagnostic Centre & Hospital", name_bn: "পপুলার ডায়াগনস্টিক সেন্টার ও হাসপাতাল", upazila: "Dhanmondi" },
  { districtSlug: "dhaka", type: "private", slug: "ibn-sina", name_en: "Ibn Sina Hospital", name_bn: "ইবনে সিনা হাসপাতাল", upazila: "Dhanmondi" },
  { districtSlug: "dhaka", type: "private", slug: "anwer-khan", name_en: "Anwer Khan Modern Medical College Hospital", name_bn: "আনোয়ার খান মডার্ন মেডিকেল কলেজ হাসপাতাল", upazila: "Dhanmondi" },
  { districtSlug: "dhaka", type: "private", slug: "holy-family", name_en: "Holy Family Red Crescent Medical College Hospital", name_bn: "হলি ফ্যামিলি রেড ক্রিসেন্ট মেডিকেল কলেজ হাসপাতাল", upazila: "Malibagh" },
  { districtSlug: "dhaka", type: "private", slug: "bangladesh-specialized", name_en: "Bangladesh Specialized Hospital", name_bn: "বাংলাদেশ স্পেশালাইজড হাসপাতাল", upazila: "Shantinagar" },
  { districtSlug: "dhaka", type: "private", slug: "asgar-ali", name_en: "Asgar Ali Hospital", name_bn: "আসগার আলী হাসপাতাল", upazila: "Wari" },
  { districtSlug: "dhaka", type: "private", slug: "japan-bangladesh", name_en: "Japan Bangladesh Friendship Hospital", name_bn: "জাপান বাংলাদেশ ফ্রেন্ডশিপ হাসপাতাল", upazila: "Dhanmondi" },
  { districtSlug: "dhaka", type: "private", slug: "green-life", name_en: "Green Life Medical College Hospital", name_bn: "গ্রিন লাইফ মেডিকেল কলেজ হাসপাতাল", upazila: "Dhanmondi" },
  { districtSlug: "dhaka", type: "private", slug: "delta", name_en: "Delta Hospital Limited", name_bn: "ডেল্টা হাসপাতাল", upazila: "Mirpur" },
  { districtSlug: "dhaka", type: "private", slug: "central", name_en: "Central Hospital Limited", name_bn: "সেন্ট্রাল হাসপাতাল", upazila: "Dhanmondi" },
  { districtSlug: "dhaka", type: "private", slug: "samorita", name_en: "Samorita Hospital", name_bn: "সামরিতা হাসপাতাল", upazila: "Panthapath" },
  { districtSlug: "dhaka", type: "private", slug: "comfort", name_en: "Comfort Nursing Home / Hospital", name_bn: "কমফোর্ট হাসপাতাল", upazila: "Dhanmondi" },
  { districtSlug: "dhaka", type: "private", slug: "ahrar", name_en: "Ahsania Mission Cancer & General Hospital", name_bn: "আহছানিয়া মিশন ক্যানসার ও জেনারেল হাসপাতাল", upazila: "Uttara" },
  { districtSlug: "dhaka", type: "private", slug: "birdem", name_en: "BIRDEM General Hospital", name_bn: "বারডেম জেনারেল হাসপাতাল", upazila: "Shahbag" },
  { districtSlug: "dhaka", type: "private", slug: "impulse", name_en: "Impulse Hospital", name_bn: "ইমপালস হাসপাতাল", upazila: "Tejgaon" },
  { districtSlug: "dhaka", type: "private", slug: "praava", name_en: "Praava Health", name_bn: "প্রাভা হেলথ", upazila: "Banani" },
  { districtSlug: "dhaka", type: "private", slug: "labaid-cardiac", name_en: "Labaid Cardiac Hospital", name_bn: "ল্যাবএইড কার্ডিয়াক হাসপাতাল", upazila: "Dhanmondi" },
  { districtSlug: "dhaka", type: "private", slug: "square-cancer", name_en: "Square Comprehensive Cancer Centre", name_bn: "স্কয়ার ক্যানসার সেন্টার", upazila: "Panthapath" },
  { districtSlug: "dhaka", type: "private", slug: "evercare-cancer", name_en: "Evercare Cancer Centre", name_bn: "এভারকেয়ার ক্যানসার সেন্টার", upazila: "Bashundhara" },
  { districtSlug: "dhaka", type: "private", slug: "brb-hospital", name_en: "BRB Hospitals", name_bn: "বিআরবি হাসপাতাল", upazila: "Panthapath" },
  { districtSlug: "dhaka", type: "private", slug: "farazy-badda", name_en: "Farazy Hospital — Badda", name_bn: "ফারাজী হাসপাতাল — বাড্ডা", upazila: "Badda" },
  { districtSlug: "dhaka", type: "private", slug: "islamiah-eye", name_en: "Islamiah Eye Hospital", name_bn: "ইসলামিয়া আই হাসপাতাল", upazila: "Farmgate" },
  // Gazipur / Narayanganj
  ...
  return [
    {
      ...
      slug: `${slug}-mch-wing`,
      name_en: `${title} Maternal & Child Health Training Institute`,
      name_bn: "মাতৃ ও শিশু স্বাস্থ্য প্রশিক্ষণ ইনস্টিটিউট",
      ...(slug === "dhaka" ? { upazila: "Sher-e-Bangla Nagar" } : {}),
    },
    {
      districtSlug: slug,
      type: "government" as const,
      slug: `${slug}-tb`,
      name_en: `${title} TB Hospital / Chest Clinic`,
      name_bn: "যক্ষ্মা / বক্ষব্যাধি হাসপাতাল",
      ...(slug === "dhaka" ? { upazila: "Mohakhali" } : {}),
    },
  ];
});
