        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-[11px] text-slate-400 mt-0.5">
              {lang === "bn"
                ? "প্রতি Nটি পোস্টের পর হরাইজন্টাল ইমেজ স্লাইডার দেখাবে।"
                : "Shows a horizontal image slider after every N posts."}
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="text-[10px] text-slate-500">
              {lang === "bn" ? "প্রতি কয়টি পোস্টের পর" : "Insert after every N posts"}
            </label>
            <input
              type="number"
              min={1}
