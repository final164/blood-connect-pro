-- Community blood donors (bulk-imported, linked to organizations)
...
CREATE INDEX IF NOT EXISTS community_donors_active_idx ON public.community_donors (is_active) WHERE is_active = true;
...
DO $$ BEGIN
  ALTER PUBLICATION supabase_realtime ADD TABLE public.community_donors;
